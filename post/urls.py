...
from post.views import AddPostView, PostListView, PostDetail, UpdatePostView, DeletePostView, search_post, post_like
...
urlpatterns = [
    ...
    path('search/', search_post, name='search-post'),
